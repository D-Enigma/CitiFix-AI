...
function MyComplaints() {
  ...
  // Load the logged-in citizen's complaints from the backend.
  const fetchComplaints = async () => {
    try {
      ...
      // Send the citizen to login when no token is available.
      if (!token) {
      ...
      // Show the backend or network error to the citizen.
      setError(
  ...
  // Format complaint dates for display.
  ...
  // Format the complaint's real GPS coordinates.
  ...
  // Return the appropriate styling for each complaint status.
  ...
  // Return the appropriate styling for each complaint priority.
  ...
  // Show complaint progress based on its current workflow status.
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-5">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap items-center gap-3">
                        ...
                        <span className="text-xs font-medium bg-slate-100 text-slate-600 px-2.5 py-1 rounded break-all">
                          {complaintId}
                        </span>
