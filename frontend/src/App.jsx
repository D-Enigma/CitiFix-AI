...
function App() {
  return (
    <BrowserRouter>
      <Routes>
        {/* Keep the landing, login, and registration pages public. */}
        <Route path="/" element={<Landing />} />
        <Route path="/login" element={<Login />} />
        <Route path="/register" element={<Register />} />

        {/* Protect all citizen pages so only logged-in users can access them. */}
        ...
        {/* Protect all admin pages so only admin accounts can access them. */}
